...
class ExtendedKalmanFilter(object):
    ...
    def predict(self, u=0):
        ...
        # row 369 is commented out, this is what was modified, they write that F is the transition matrix.
        # In that case, it should not be used to update the covariance matrix P at row 370, this should be updated 
        # with Jacobian matrix. And if you set F to the jacobian, you should not use it in self.predict_x at row 350 
        # since this should be updated with the state covariance matrix
        # self.predict_x(u)
